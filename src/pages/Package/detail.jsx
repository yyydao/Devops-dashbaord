...
class packageDetail extends Component {
  ...
  render () {
    ...
    if (status === 0) {
      cardTitle = fileName
      downloadButton = <Button ghost type="primary" icon="download"><a href={appUrl} target="_blank">下载</a></Button>
    ...
    if (jenkinsStatus === 1|| jenkinsStatus === 2){
      cancleButton = <Button ghost type="primary" icon="redo" onClick={(e)=>{onCancleSuccess(null,buildId,envId)}}>取消构建</Button>
